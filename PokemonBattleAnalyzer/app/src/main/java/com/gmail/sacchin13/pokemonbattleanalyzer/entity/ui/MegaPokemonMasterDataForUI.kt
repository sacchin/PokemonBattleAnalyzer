...
open class MegaPokemonMasterDataForUI(
    ...
    companion object {
        ...
        fun create(pokemonNo: String, h: Int, a: Int, b: Int, c: Int, d: Int, s: Int, type1: Int, type2: Int,
                   weight: Float, ability: String, megaType: Int): MegaPokemonMasterDataForUI {
            return MegaPokemonMasterDataForUI(pokemonNo, h, a, b, c, d, s, type1, type2, weight, ability, megaType)
        }
    }
}