...
class MegaPokemonInsertHandler(private val databaseHelper: DatabaseHelper?) {
    fun run() {
        ...
        databaseHelper.insertMegaPokemonDataX("006", 78, 130, 111, 130, 85, 100, "かたいツメ", 110.5f)
        ...
        databaseHelper.insertMegaPokemonDataX("127", 65, 155, 120, 65, 90, 105, "スカイスキン", 59.0f)
        databaseHelper.insertMegaPokemonDataX("130", 95, 155, 109, 70, 130, 81, "かたやぶり", 305.0f)
        databaseHelper.insertMegaPokemonDataX("142", 80, 135, 85, 70, 95, 150, "かたいツメ", 79.0f)
        databaseHelper.insertMegaPokemonDataX("150", 106, 190, 100, 154, 100, 130, "ふくつのこころ", 127.0f)
        databaseHelper.insertMegaPokemonDataX("150", 106, 150, 70, 194, 120, 140, "ふみん", 33.0f)
        databaseHelper.insertMegaPokemonDataX("181", 90, 95, 105, 165, 110, 45, "かたやぶり", 61.5f)
        ...
        databaseHelper.insertMegaPokemonDataX("254", 70, 110, 75, 145, 85, 145, "ひらいしん", 55.2f)
        ...
        databaseHelper.insertMegaPokemonDataX("306", 70, 140, 230, 60, 80, 50, "フィルター", 395.0f)
        ...
        databaseHelper.insertMegaPokemonDataX("334", 75, 110, 110, 110, 105, 80, "フェアリースキン", 20.6f)
        ...
        databaseHelper.insertMegaPokemonDataX("428", 65, 136, 94, 54, 96, 135, "きもったま", 28.3f)
        ...
        databaseHelper.insertMegaPokemonDataX("531", 103, 60, 126, 80, 126, 50, "いやしのこころ", 32.0f)

        databaseHelper.insertMegaPokemonDataX("681", 60, 150, 50, 150, 50, 60, "バトルスイッチ", 53.0f)
        databaseHelper.insertMegaPokemonDataX("555", 105, 30, 105, 140, 105, 55, "ダルマモード", 92.9f)
