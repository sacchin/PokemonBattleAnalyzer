...
class MegaPokemonInsertHandler(private val databaseHelper: PartyDatabaseHelper) : Runnable {

    fun initInsert() {
        val megaPokemonArray = JSONArray()
        try {
            val megaFushigibana = JSONObject()
            ...
            for (i in 0..megaPokemonArray.length() - 1) {
