...
class TypeTest {
    ...
    fun testCalculateAffinity() {
        ...
        var result = Type.calculateAffinity(Type.Code.FIRE, Type.code(kucheat.type1), Type.code(kucheat.type2))
        assertEquals(2.0, result, 0.1)
        result = Type.calculateAffinity(Type.Code.DRAGON, Type.code(kucheat.type1), Type.code(kucheat.type2))
        assertEquals(0.0, result, 0.1)
        result = Type.calculateAffinity(Type.Code.FIGHTING, Type.code(kucheat.type1), Type.code(kucheat.type2))
        assertEquals(1.0, result, 0.1)
        result = Type.calculateAffinity(Type.Code.UNKNOWN, Type.code(kucheat.type1), Type.code(kucheat.type2))
        assertEquals(-1.0, result, 0.1)
        ...
        result = Type.calculateAffinity(Type.Code.FIGHTING, Type.code(torimian.type1), Type.code(torimian.type2))
        assertEquals(2.0, result, 0.1)
        result = Type.calculateAffinity(Type.Code.DRAGON, Type.code(torimian.type1), Type.code(torimian.type2))
        assertEquals(1.0, result, 0.1)
        result = Type.calculateAffinity(Type.Code.UNKNOWN, Type.code(torimian.type1), Type.code(torimian.type2))
        assertEquals(-1.0, result, 0.1)
    }
}
